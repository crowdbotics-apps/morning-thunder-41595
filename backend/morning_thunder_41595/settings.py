"""
Django settings for morning_thunder_41595 project.
...
ROOT_URLCONF = 'morning_thunder_41595.urls'
...
WSGI_APPLICATION = 'morning_thunder_41595.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_thunder_41595 API",
    "DESCRIPTION": "API documentation for morning_thunder_41595 App",
    "VERSION": "v1",
}
